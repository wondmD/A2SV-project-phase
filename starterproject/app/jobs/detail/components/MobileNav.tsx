...
const MobileNav = () => {
  return (
    ...
    <div className="flex flex-col fixed bottom-0 left-0 w-full bg-white shadow-sm md:shadow-none z-50 md:top-0 md:fixed md:bottom-full">

      <div className="border border-gray-300 py-3 flex gap-1 bg-white rounded-md ">
        <div className="group relative px-4 cursor-pointer">
          <div className="flex h-10 w-20 mx-3 items-center justify-center rounded-full hover:text-blue-500">
